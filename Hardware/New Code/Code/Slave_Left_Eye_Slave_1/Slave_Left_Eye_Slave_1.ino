...
#define SCREEN_HEIGHT 64 //pixel height
...
void receiveEvent(int howmany) {
  ...
  {
    LEyeHoldingRegister[ia] = Wire.read();
        Serial.print(LEyeHoldingRegister[ia]);  
  }
  Eye_State = LEyeHoldingRegister[1];
  
  Blink = LEyeHoldingRegister[2];
