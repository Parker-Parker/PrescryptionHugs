...
public class NullCard extends Card {// this is a special "virtual" card, it is meant to represent striking an
                                    // unoccupied card slot
    ...
    public int takeDamage(int damage, Card card) {
        ...
        // if(!(card == null)){
        // card.takeDamage(1, null);//realistically, if i wanted this to be robust, I
        // would always pass the dmg src, and add a list of damage tags(poison, quill,
        // etc). oh well
        // }
        // }
        // }
